 ...
 * ----------------------
 * @brief Represents a row from the a1-data-curricular.csv file and similarly for the a1-data-extracurricular.yaml file.
 */
typedef struct {
    int record_id;
    int hours_studied;
...
/* --------------------------------------------------------------------------
 *  Debug print helper
 * @brief contains simple debugging code that I needed to fix YAML file parsing issues. 
 * -------------------------------------------------------------------------- */
...
/* --------------------------------------------------------------------------
 *  YAML reading (line by line, naive approach)
 * -------------------------------------------------------------------------- */
